$(document).ready(function () {
    ...
    function getUVIndex() {
                   cnt = 1;
                   var queryURLUvi = `https://api.openweathermap.org/data/2.5/uvi?appid=${apiKey}&lat=${lat}&lon=${lon}&cnt=${cnt}`;
                   $.ajax({
                        url: queryURLUvi,
                        method: "GET"
    ...
    function get5DayForecast() {
                   ...
                   $.ajax({
                        ...
                        $("#12").attr("src", `https://openweathermap.org/img/wn/${objArray[0].icon}@2x.png`);
                        ...
                        $("#22").attr("src", `https://openweathermap.org/img/wn/${objArray[1].icon}@2x.png`);
                        ...
                        $("#32").attr("src", `https://openweathermap.org/img/wn/${objArray[2].icon}@2x.png`);
                        ...
                        $("#42").attr("src", `https://openweathermap.org/img/wn/${objArray[3].icon}@2x.png`);
                        ...
                        $("#52").attr("src", `https://openweathermap.org/img/wn/${objArray[4].icon}@2x.png`);
